...
public class MusicPlayerStatePacket implements Packet {
    ...
    public MusicPlayerStatePacket(PacketByteBuf buf) {
    ...
    public MusicPlayerStatePacket(int x, int y, int z, boolean play, int currentTime, boolean signal, ItemStack stack) {
        this(x, y, z, play, currentTime, signal, 0, stack, "", 0, "");
    }

    public MusicPlayerStatePacket(int x, int y, int z, boolean play, int currentTime, boolean signal, int playSessionId,
    ...
    private MusicPlayerStatePacket(int x, int y, int z, boolean play, int currentTime, boolean signal, ItemStack stack,
    ...
    public void apply(EntityPlayer entityPlayer) {
        ...
        if (!this.play) {
            ClientMusicPlayer.stopAt(this.x, this.y, this.z, "state_play_false");
            return;
        }
