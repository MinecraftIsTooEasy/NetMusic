...
public class SetMusicIDPacket implements Packet {
    ...
    public SetMusicIDPacket(PacketByteBuf packetByteBuf) {
        this(Source.fromOrdinal(packetByteBuf.readInt()), readSongInfo(packetByteBuf));
    }

    public SetMusicIDPacket(Source source, ItemMusicCD.SongInfo song) {
