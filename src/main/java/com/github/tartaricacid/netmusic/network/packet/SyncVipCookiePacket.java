...
public class SyncVipCookiePacket implements Packet {
    ...
    public SyncVipCookiePacket(PacketByteBuf buf) {
        this(buf.readString(), buf.readString());
    }

    public SyncVipCookiePacket(String neteaseCookie, String qqCookie) {
